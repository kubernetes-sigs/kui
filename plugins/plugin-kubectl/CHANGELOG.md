...
- **plugins/plugin-kubectl:** fetchFileString aggressively calls toString on all objects ([01c1964](https://github.com/IBM/kui/commit/01c1964)), closes [#6941](https://github.com/IBM/kui/issues/6941)
