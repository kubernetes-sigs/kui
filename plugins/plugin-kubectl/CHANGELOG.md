...
- **plugins/plugin-kubectl:** kubectl top nodes can present "NaN" ([30df3dd](https://github.com/kui-shell/plugin-kubeui/commit/30df3dd)), closes [#4189](https://github.com/kui-shell/plugin-kubeui/issues/4189)
- the colors of status badges: Error, ImagePullBackOff and ErrImagePull are incorrect ([fd206f6](https://github.com/kui-shell/plugin-kubeui/commit/fd206f6)), closes [#4171](https://github.com/kui-shell/plugin-kubeui/issues/4171)
...
- **plugins/plugin-kubectl:** kubectl api-resources table shows 'unknown' in title ([0461710](https://github.com/kui-shell/plugin-kubeui/commit/0461710)), closes [#4145](https://github.com/kui-shell/plugin-kubeui/issues/4145)
- **plugins/plugin-kubectl:** kubectl watch tables can be misparsed ([cb3e1c2](https://github.com/kui-shell/plugin-kubeui/commit/cb3e1c2)), closes [#4139](https://github.com/kui-shell/plugin-kubeui/issues/4139)
...
- **plugins/plugin-kubectl:** watch table doesn't have breadcrumbs title ([43fbe6a](https://github.com/kui-shell/plugin-kubeui/commit/43fbe6a)), closes [#4135](https://github.com/kui-shell/plugin-kubeui/issues/4135)
