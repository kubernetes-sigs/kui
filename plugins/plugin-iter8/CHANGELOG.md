...
# [13.0.0-dev-20221221-131328](https://github.com/starpit/kui/compare/v4.5.0...v13.0.0-dev-20221221-131328) (2022-12-21)


### Bug Fixes

* notebooks loaded from kui vfs do not display sample output ([6fc193e](https://github.com/starpit/kui/commit/6fc193e))
* **packages/core:** Capabilities API added and documentation updated ([31be8fc](https://github.com/starpit/kui/commit/31be8fc))
* **packages/core:** Events api created and typedoc documentation generated ([531461d](https://github.com/starpit/kui/commit/531461d))
* **plugins/plugin-client-common:** group the notebooks together in the ls -l table ([1a783f3](https://github.com/starpit/kui/commit/1a783f3)), closes [#5977](https://github.com/starpit/kui/issues/5977)
* **plugins/plugin-client-common:** isReplay bit on Blocks is not set for snapshots ([c6d1633](https://github.com/starpit/kui/commit/c6d1633)), closes [#5868](https://github.com/starpit/kui/issues/5868)
* **plugins/plugin-iter8:** avoid collisions with global css rules ([8fff7b4](https://github.com/starpit/kui/commit/8fff7b4)), closes [#5432](https://github.com/starpit/kui/issues/5432)
* **plugins/plugin-iter8:** fix for typing errors in plugin-iter8 ([bf20b03](https://github.com/starpit/kui/commit/bf20b03)), closes [#6432](https://github.com/starpit/kui/issues/6432)
* **plugins/plugin-iter8:** minor install command edit in notebook ([0691c4d](https://github.com/starpit/kui/commit/0691c4d))
* **plugins/plugin-iter8:** remove use of patternfly's Touchspin ([c8f9351](https://github.com/starpit/kui/commit/c8f9351)), closes [#6875](https://github.com/starpit/kui/issues/6875)
* improve existing notebooks for v1 ([1af5cc2](https://github.com/starpit/kui/commit/1af5cc2)), closes [#5858](https://github.com/starpit/kui/issues/5858)
* store the commentary text result to the command when editing is done ([5a3f5e8](https://github.com/starpit/kui/commit/5a3f5e8)), closes [#5916](https://github.com/starpit/kui/issues/5916) [#5672](https://github.com/starpit/kui/issues/5672)
* **plugins/plugin-iter8:** iter8 create experiment combo boxes have misplaced svg ([dfc6cfb](https://github.com/starpit/kui/commit/dfc6cfb)), closes [#5419](https://github.com/starpit/kui/issues/5419)
* **plugins/plugin-iter8:** Removed execSync from iter8 plugin ([1899a78](https://github.com/starpit/kui/commit/1899a78)), closes [#5408](https://github.com/starpit/kui/issues/5408)


### chore

* port notebooks to markdown ([a64295d](https://github.com/starpit/kui/commit/a64295d))
* remove unused/untested iter8 components ([82e3513](https://github.com/starpit/kui/commit/82e3513))


### Features

* add support for left strip positioning of terminal splits ([a8dc71f](https://github.com/starpit/kui/commit/a8dc71f)), closes [#8202](https://github.com/starpit/kui/issues/8202)
* extend markdown tab syntax to be presented as a Wizard UI ([173e436](https://github.com/starpit/kui/commit/173e436))
* update Iter8 notebooks ([69d1ec0](https://github.com/starpit/kui/commit/69d1ec0))
* when inlining guidebook snippets, rewrite relative image links ([b403164](https://github.com/starpit/kui/commit/b403164))
* **plugins/plugin-iter8:** added new iter8 plugin ([82989ab](https://github.com/starpit/kui/commit/82989ab)), closes [#5400](https://github.com/starpit/kui/issues/5400)
