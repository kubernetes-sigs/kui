...
import { ModeFilter, registerMode, ModeRegistration } from '@kui-shell/core/api/registrars'
...
async function registerModes() {
  ...
  return Promise.all([registerMode(flowSpec), registerMode(traceSpec), registerMode(logsSpec)])
}
