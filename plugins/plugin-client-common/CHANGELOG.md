...
- **plugins/plugin-client-common:** sidecar maximization is a bit off when in a split ([fb9997e](https://github.com/IBM/kui/commit/fb9997e)), closes [#6531](https://github.com/IBM/kui/issues/6531)
...
- **plugins/plugin-client-common:** in patternfly-based components, the CurrentContext widget has poor alignment ([ef71a2e](https://github.com/IBM/kui/commit/ef71a2e)), closes [#6494](https://github.com/IBM/kui/issues/6494)
...
- **plugins/plugin-client-common:** minor Output alignment regression ([9edb242](https://github.com/IBM/kui/commit/9edb242)), closes [#6438](https://github.com/IBM/kui/issues/6438)
