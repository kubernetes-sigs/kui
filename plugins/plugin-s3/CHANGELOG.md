...
- port gunzip and gzip to use new job controller ([30c653c](https://github.com/IBM/kui/commit/30c653c)), closes [#6277](https://github.com/IBM/kui/issues/6277)
...
- **plugins/plugin-se:** CodeEngine.ts uses invalid option ([34f52aa](https://github.com/IBM/kui/commit/34f52aa)), closes [#6237](https://github.com/IBM/kui/issues/6237)
