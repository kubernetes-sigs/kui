...
describe('wsk action update without input file', function (this: ISuite) {
  ...
  it('should update the action with no code via kui action update', () => cli.do(`kui action update ${actionName} -p y 5`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
    .then(sidecar.expectShowing(actionName))
    .catch(common.oops(this)))
  ...
  it('should update the action with no code via wsk action update', () => cli.do(`wsk action update ${actionName} -p y 6`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
    .then(sidecar.expectShowing(actionName))
    .catch(common.oops(this)))
