...
* **packages/proxy:** pass through KUI_ env vars from proxy container to user ([cb0c729](https://github.com/IBM/kui/commit/cb0c729)), closes [#8120](https://github.com/IBM/kui/issues/8120)
